...
function singleJob() {
	return {
		...
		location: faker.helpers.arrayElement([
			...
			'Bandeira de Campos Belos.svg Campos Belos',
			'Campos Verdes',
			'Carmo do Rio Verde',
			'Castelândia',
			'Catalão',
			...
			'Firminópolis',
			'Flores de Goiás',
			'Bandeira de Formosa - GO.svg Formosa',
			'Formoso',
			'Gameleira de Goiás',
			'Goianápolis',
			'Goianésia',
			...
			'Montividiu do Norte',
			'Bandeira de Montividiu GO.svg Montividiu',
			'Morrinhos',
			...
			'Matrinchã',
			'Moiporá',
			'Bandeira municipio doverlandia-go.svg Doverlândia',
			'Nazário',
			'Nova Glória',
			'Nova Veneza',
			'Orizona',
